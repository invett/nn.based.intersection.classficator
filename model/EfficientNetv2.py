...
class EfficientNetv2(torch.nn.Module):
    ...
    def __init__(self, pretrained=True, embeddings_size=512, num_classes=None, version='efficientnet_v2_s'):
        super().__init__()
        ...
        if pretrained:
            model = torch.hub.load("pytorch/vision", 'efficientnet_v2_s', weights="DEFAULT")
        else:
