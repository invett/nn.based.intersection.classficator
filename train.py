...
def train(args, model, optimizer, scheduler, dataloader_train, dataloader_val, valfolder, GLOBAL_EPOCH,
    ...
    if args.embedding:  # For Teacher/Student training
        ...
        if args.distance_function == 'SNR':
            ...
            if args.miner:
                miner = miners.TripletMarginMiner(margin=args.margin*2, type_of_triplets="all", distance=SNRDistance())
            else:
                miner = None
            ...
            if args.miner:
                miner = miners.TripletMarginMiner(margin=args.margin*2, type_of_triplets="all", distance=LpDistance(p=args.p))
            else:
                miner = None
            ...
            if args.miner:
                miner = miners.TripletMarginMiner(margin=args.margin*2, type_of_triplets="all", distance=CosineSimilarity())
            else:
                miner = None
