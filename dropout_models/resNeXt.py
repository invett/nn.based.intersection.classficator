...
from dropout_models import conv_block
...
class ResNeXt(nn.Module):
    def __init__(self, args, cardinality, d_width, num_classes):
        ...
        self.classifier = nn.Linear(stages[3], num_classes)
...
def get_resnext(args):
    return ResNeXt(args, cardinality, d_width, num_classes)
